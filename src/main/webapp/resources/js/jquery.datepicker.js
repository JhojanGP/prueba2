	...
	$.extend(
		...
		{	
			...
			setEndDate : function(d)
			{
				...
				if (!this.endDate) {
					this.endDate = (new Date('12/31/1999')); // using the JS Date.parse function which expects mm/dd/yyyy
				}
...
//					$('.selectee', this.context).focus();
	...
	// localisable text
	$.dpText = {
		TEXT_PREV_YEAR		:	'Anterior AÑO',
		TEXT_PREV_MONTH		:	'Anterior MES',
	...
	// version
	$.dpVersion = '$Id: jquery.datePicker.js 84 2009-08-05 17:54:35Z lenox.pristom@hotmail.com $';
