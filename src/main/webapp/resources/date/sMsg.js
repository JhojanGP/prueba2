...
| Updated: 17.04.2003                               |
|		   06.01.2005								|	
| LastModify:  12.01.2006 by asullom@hotmail.com    |	
|													|	
...
function clickMenu(tree, url, frame) {
	...
	if (frame == '_self')
		self.location.href=url+ "&node=" + tree.selectedNode;
	else if (frame == '_parent')
		parent.location.href=url+ "&node=" + tree.selectedNode;
	else {			
		var foundIndex;
...
function clickMenux(tree, url, frame) {
	//var str = '';	str += ' onclick="javascript: ' +url +'";';
	//parent.mainFrame.location.href=url;	
	if (frame == '_self')
		...
		////parent.frames[foundIndex].location.href=url + "?node=" + tree.getSelected();
		//parent.frames[foundIndex].location.href=url + "?node=" + tree.selectedNode;
		parent.frames[foundIndex].location.href='# onclick="javascript: ' +url +'";';
	}
...
function dTree(objName, imgFolder, inFrame) {
	...
	this.icon = {
		...
		node				: imgFolder + '/file.gif',

		empty				: imgFolder + '/empty.gif',

		line				: imgFolder + '/linevertical.gif',

		join				: imgFolder + '/linemiddlenode.gif',

		joinBottom			: imgFolder + '/linelastnode.gif',

		plus				: imgFolder + '/handlerightmiddle.gif',

		plusBottom			: imgFolder + '/handlerightlast.gif',

		minus				: imgFolder + '/handledownmiddle.gif',

		minusBottom			: imgFolder + '/handledownlast.gif',

		nlPlus				: imgFolder + '/handlerightmiddle.gif',
...
//		str += '<a id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" href="' + node.url + '"';
		...
		if (this.config.useSelection && ((node._hc && this.config.folderLinks) || !node._hc))
			...
			str += ' onclick="javascript: ' + this.obj + '.s(' + nodeId + ');'+ node.url +'"';
		//else
			//str += ' onclick="javascript: ' + node.url + ';"';	
